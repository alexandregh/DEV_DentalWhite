<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Dental_White.UI.Pages.Paciente.Cadastro.Default" Buffer="true" Trace="false" EnableTheming="false" %>
                    ...
                    <legend>Telefone:</legend>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <label>Tipo de Telefone:</label>
                                    <asp:DropDownList ID="ddlTipoTelefone2" runat="server" Width="45.5%" OnSelectedIndexChanged="ddlTipoTelefone2_SelectedIndexChanged" AutoPostBack="True" CssClass="textbox">
                                        <asp:ListItem Value="" Text="-Selecione-" Selected="True"></asp:ListItem>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <label>Tipo de Telefone:</label>
                                    <asp:DropDownList ID="ddlTipoTelefone3" runat="server" Width="45.5%" OnSelectedIndexChanged="ddlTipoTelefone3_SelectedIndexChanged" AutoPostBack="True" CssClass="textbox">
                                        <asp:ListItem Value="" Text="-Selecione-" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="Residencial">Residencial</asp:ListItem>
                                        <asp:ListItem Value="Celular">Celular</asp:ListItem>
                                        <asp:ListItem Value="Recado">Recado</asp:ListItem>
