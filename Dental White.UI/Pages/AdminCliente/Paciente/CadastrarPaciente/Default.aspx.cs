        ...
        protected void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(erros != true) // Se não existir erros...
                {
                    ...
                    {
                        pnlMensagemErro.Visible = true;
                        lblMensagemErro.Text = "Paciente já cadastrado.";
                    }
                    else
                    {
                        ...
                        this.InserirEndereco(entityPaciente); // Contém todas as informações do Paciente, Endereço e Logradouro
                        ...
                        else
                        {
                            ...
                            if (qtdTelefone == 1)
                            {
                                dalCadastroPaciente.InsertPaciente(entityPaciente, entityTelefone1);
                                contatoTelefone = true;
                            }
                            if (qtdTelefone == 2)
                            {
                                dalCadastroPaciente.InsertPaciente(entityPaciente, entityTelefone1, entityTelefone2);
                                contatoTelefone = true;
                            }
                            if (qtdTelefone == 3)
                            {
                                dalCadastroPaciente.InsertPaciente(entityPaciente, entityTelefone1, entityTelefone2, entityTelefone3);
                                contatoTelefone = true;
                            }
                            else
                            {
