<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Dental_White.UI.Pages.AdminCliente.Paciente.InserirFoto.Default" Buffer="true" Trace="false" EnableTheming="false" %>
    ...
    <section id="sectionBody">
        <section id="contentBody">
            ...
            <article class="frmCadastroPaciente">
                <h3>Inserir/Visualizar Sua Foto de Paciente</h3><br />
