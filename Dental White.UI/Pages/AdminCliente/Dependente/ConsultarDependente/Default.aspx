<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Dental_White.UI.Pages.AdminCliente.Dependente.AtualizarDependente.Default" Buffer="true" Trace="false" EnableTheming="false" %>
        ...
        <section id="contentBody">
            ...
            <ContentTemplate>
                ...
                <section class="boxContainnerTipoPesquisa">
                    <h3>Consultar Dados do Dependente</h3><br />
            ...
            <asp:Panel ID="pnlConsultarPaciente" runat="server" Visible="false">
                <section class="frmCadastroPaciente">
                    ...
                    <fieldset id="fieldsetDocumentos">
                        ...
                        <label class="lista">Data de Emissão:</label>
                        ...
                        <legend>Grau de Parentesco</legend>
                            ...
                            <asp:Label ID="lblNivelGrauParentesco" runat="server" Font-Bold="true"></asp:Label><br /><br />
                            <label>Descrição do Grau de Parentesco:</label><br />
                            <asp:TextBox ID="txtDescricaoGrauParentesco" runat="server" TextMode="MultiLine" ReadOnly="true" Height="70" Width="99%" CssClass="textbox" Font-Bold="true"></asp:TextBox>
                        </fieldset>
                    </fieldset>
