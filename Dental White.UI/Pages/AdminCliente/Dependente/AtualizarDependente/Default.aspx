<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Admin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Dental_White.UI.Pages.AdminCliente.Dependente.AtualizarDependente.Default1" Buffer="true" Trace="false" EnableTheming="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSectionBody" runat="server">
    <section id="sectionBody">
        <section id="contentBody">
            ...
            <asp:Panel ID="pnlMensagemSucesso" runat="server" Visible="false">
                <section>
                    <article class="boxContainnerMensagem">
                        <h2 class="txtTituloMensagemSucesso">Atualização realizada com sucesso.</h2><br />
                    </article>
                </section>
            </asp:Panel>
            <section class="boxContainnerTipoPesquisa">
                <h3>Atualizar Dados do Dependente</h3><br />
            ...
            <asp:Panel ID="pnlAtualizarPaciente" runat="server" Visible="false">
                <section class="frmCadastroPaciente">
                    <h1>Formulário de Paciente - Módulo Atualizar Paciente.</h1><br />
                        <fieldset id="fieldsetDadosPessoais">
                        <legend>Dados Pessoais:</legend>
                            <asp:Panel ID="pnllblLogin" runat="server" Visible="false">
                                <label>Login:</label><br />
                                <asp:Label ID="lblLogin" runat="server" Font-Bold="true"></asp:Label><br /><br />
                            </asp:Panel>
                            <asp:Panel ID="pnltxtLogin" runat="server" Visible="false">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorLogin" runat="server" ControlToValidate="txtLogin" Display="Dynamic" ErrorMessage="Campo Login é obrigatório." Text="*" ForeColor="Red" EnableClientScript="false" Enabled="false"></asp:RequiredFieldValidator>
                                <label>Login:</label><br />
                                <asp:TextBox ID="txtLogin" runat="server" MaxLength="50" Width="99%" CssClass="textbox"></asp:TextBox><br /><br />
                            </asp:Panel>
                        ...
                        <legend>Documentos:</legend>
                            ...
                            <label>CPF:</label><br />
                            <asp:TextBox ID="txtCPF" runat="server" Width="99%" CssClass="textbox" MaxLength="11"></asp:TextBox><br /><br />
                            <label>RG:</label><br />
                            ...
                            <asp:TextBox ID="txtNumeroRG" runat="server" Width="99%" CssClass="textbox" MaxLength="11"></asp:TextBox><br /><br />
                            ...
                            <asp:TextBox ID="txtDataEmissao" runat="server" Type="date" Width="99%" CssClass="textbox"></asp:TextBox>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label>Número:</label>
                                        <asp:TextBox ID="txtNumeroTelefone1" runat="server" Width="39%" CssClass="textbox"></asp:TextBox><br /><br />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label>Número:</label>
                                        <asp:TextBox ID="txtNumeroTelefone2" runat="server" Width="39%" CssClass="textbox"></asp:TextBox><br /><br />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label>Número:</label>
                                        <asp:TextBox ID="txtNumeroTelefone3" runat="server" Width="39%" CssClass="textbox"></asp:TextBox><br /><br />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                        ...
                        <label>CEP:</label><br />
                        <asp:TextBox ID="txtCEP" runat="server" MaxLength="8" Width="99%" CssClass="textbox"></asp:TextBox><br /><br />
